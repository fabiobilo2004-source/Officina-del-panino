...
export default function Home() {
  ...
  // Mobile: video grows from small to almost-fullscreen on scroll
  const lavorazioneVidW  = useTransform(lavorazioneScrollY, [0.0, 0.45], ["160px", "92vw"]);
  const lavorazioneVidMX = useTransform(lavorazioneScrollY, [0.0, 0.45], ["0px",   "-24px"]);
  const estateVidW       = useTransform(estateScrollY,      [0.0, 0.45], ["160px", "92vw"]);
  const estateVidMX      = useTransform(estateScrollY,      [0.0, 0.45], ["0px",   "-24px"]);
  const paneVidW         = useTransform(paneScrollY,        [0.0, 0.45], ["160px", "92vw"]);
  const paneVidMX        = useTransform(paneScrollY,        [0.0, 0.45], ["0px",   "-24px"]);
          ...
          {[
            ...
            <>
              <div key={value} className="flex-1 flex flex-col items-center gap-1">
                ...
                <span className="font-display text-2xl sm:text-3xl md:text-4xl text-primary leading-none text-center">
                  {value}
                </span>
              </div>
              {i < arr.length - 1 && (
      ...
      <section ref={lavorazioneSectionRef} className="py-24 bg-background border-b border-border/30 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:gap-16 relative z-10">
          ...
          <motion.div
            ...
            style={isMobile ? { width: lavorazioneVidW, maxWidth: "92vw", marginLeft: lavorazioneVidMX, marginRight: lavorazioneVidMX, aspectRatio: "9/16" } : { width: "100%", maxWidth: "340px", aspectRatio: "9/16" }}
          >
            <video
      ...
      <section ref={estateSectionRef} className="py-24 bg-card border-b border-border/30">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row-reverse items-center gap-12 md:gap-16">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
            className="relative overflow-hidden border border-border/40 flex-shrink-0 md:w-full md:max-w-[340px]"
            style={isMobile ? { width: estateVidW, maxWidth: "92vw", marginLeft: estateVidMX, marginRight: estateVidMX, aspectRatio: "9/16" } : { width: "100%", maxWidth: "340px", aspectRatio: "9/16" }}
          >
            <video
              ref={estateVideoRef}
      ...
      <section ref={paneSectionRef} className="py-24 bg-background border-b border-border/30 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:gap-16 relative z-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1], delay: 0.1 }}
            className="relative overflow-hidden border border-border/40 flex-shrink-0 md:w-full md:max-w-[340px]"
            style={isMobile ? { width: paneVidW, maxWidth: "92vw", marginLeft: paneVidMX, marginRight: paneVidMX, aspectRatio: "9/16" } : { width: "100%", maxWidth: "340px", aspectRatio: "9/16" }}
          >
            <video
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <span className="w-10 flex justify-center flex-shrink-0"><SiJusteat size={28} /></span>
                ...
                >
                  <span className="w-10 flex justify-center flex-shrink-0"><img src="/images/logo-rimini-cropped.webp" alt="Rimini" className="w-10 h-10 object-contain" /></span>
                  Rimini — 0541 141 9757
                </a>
                <a
                  href="tel:+3905411840930"
                  className="flex items-center gap-4 px-6 py-5 border border-border bg-background font-display uppercase tracking-widest text-sm text-muted-foreground hover:border-primary hover:text-primary transition-colors"
                >
                  <span className="w-10 flex justify-center flex-shrink-0"><img src="/images/logo-santarcangelo.png" alt="Santarcangelo" className="w-10 h-10 object-contain" /></span>
                  Santarcangelo — 0541 184 0930
                </a>
              </div>
            </motion.div>
