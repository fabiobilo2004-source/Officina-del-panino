  ...
  return (
    <div className="py-8 px-4 md:py-12 md:px-6 bg-background">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-center gap-1 md:gap-8 flex-wrap md:flex-nowrap">
          {/* Sandwich */}
          ...
          {/* Total Price */}
          <div className="flex flex-col items-center border-l border-primary/30 pl-3 md:pl-8">
            <p className="text-[10px] md:text-xs tracking-widest uppercase text-muted-foreground mb-1 font-semibold">
